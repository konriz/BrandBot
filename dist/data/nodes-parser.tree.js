...
const nodes_tree_json_1 = __importDefault(require("./nodes.tree.json"));
...
class NodesTreeParser {
    ...
    static populateNodes() {
        let tree = [];
        for (let nodeData of nodes_tree_json_1.default["nodes"]) {
...
//# sourceMappingURL=nodes-parser.tree.js.map